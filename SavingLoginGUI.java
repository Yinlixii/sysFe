...
public class SavingLoginGUI extends JPanel{
	private JPanel p1;
	private JPanel p2;
    ...
    private JLabel jl = new JLabel("Saving Account Login");
    private JLabel jErrorLogin = new JLabel("password error!");
    
    public SavingLoginGUI(GUI GUI) {
    	this.setLayout(null);
        ...
        bLogin.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	if(!String.valueOf(tPwd.getPassword()).equals("")&&!tUsername.getText().equals(""))
            	{
            		...
            		if(!GUI.data.getCustomerAccounts().isEmpty()&&GUI.data.CustomerLogin(username,pwd,"saving")) {
            			p1 = new SavingGUI(GUI);
            			GUI.cards.add(p1,"saving");
        ...
        bRegister.addActionListener(new ActionListener() {       
            @Override
            public void actionPerformed(ActionEvent e) {
            	p2 = new RegisterGUI(GUI,2);
                GUI.cards.add(p2,"registerSaving");
            	GUI.cl.show(GUI.cards, "registerSaving");
            }
        });
